            ...
            <form action="{{ route('admin.rebar.sites.update', $site) }}" method="POST" class="p-5 md:p-6 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="col-span-2 md:col-span-1">
                            ...
                            <input type="text" value="{{ $site->site_code }}" disabled
                                class="w-full bg-slate-100 border border-slate-200 rounded-xl py-2 px-3 font-black text-slate-500 cursor-not-allowed text-sm">
                            ...
                            <label class="block text-xs font-black text-slate-400 uppercase tracking-[0.2em] mb-3">Status
                                ...
                                <select name="status" required
                                    ...
                                    <option value="Completed" {{ old('status', $site->status) == 'Completed' ? 'selected' : '' }}>
                                        Completed</option>
                                    <option value="Terminated" {{ old('status', $site->status) == 'Terminated' ? 'selected' : '' }}>Terminated</option>
                                </select>
                        ...
                        @foreach(['08', '10', '12', '14', '16', '20', '24', '32'] as $d)
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <input type="number" name="price_{{ $d }}" value="{{ old('price_'.$d, $site->{'price_'.$d}) }}" step="0.01" placeholder="0.00"
                ...
                <div class="bg-white rounded-2xl border border-slate-200 p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <select name="manager_id" class="w-full bg-slate-50 border border-slate-200 rounded-xl py-2 px-3 focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-500 transition-all font-bold text-slate-700 text-sm mb-3">
                        ...
                        <textarea name="notes" rows="3" placeholder="Additional details about the site..."
                            class="w-full bg-slate-50 border border-slate-200 rounded-xl py-2 px-3 focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-500 transition-all font-bold text-slate-700 text-sm">{{ old('notes', $site->notes) }}</textarea>
